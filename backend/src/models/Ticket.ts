...
import MensagemTransferencia from "./TransferConversation";
...
class Ticket extends Model<Ticket> {
  ...
  @Column(DataType.DATE)
  lastBusinessHourMessageAt: Date;
  ...
  @ForeignKey(() => EndConversation)
  @AllowNull
  @Column
  endConversationId: number;

  @BelongsTo(() => EndConversation)
  ...
  @AllowNull
  @Column
  confidentialUserId: number;

  @BelongsTo(() => User, "confidentialUserId")
  confidentialUser: User;

  @Default(false)
  @Column(DataType.VIRTUAL)
  showConfidentialMessages: boolean;
