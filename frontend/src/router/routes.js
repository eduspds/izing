...
const routes = [
  {
    ...
    children: [
      ...
      { path: '/releases', name: 'releases', component: () => import('pages/releases/Index.vue') },
      { path: '/motivos-encerramento', name: 'motivos-encerramento', component: () => import('pages/motivosEncerramento/Index.vue') },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'RelatorioGeral',
        name: 'RelatorioGeral',
        component: () => import('pages/relatorios/RelatorioGeral')
      }
    ]
  },
  {
