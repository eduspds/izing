      ...
      <q-page class="flex justify-center items-center">
        ...
        <q-card bordered
          ...
          <q-card-section class="text-primary text-center">
            <q-img src="/logo horizontal.png"
              spinner-color="white"
              style="height: 80px; max-width: 500px"
              class="q-mb-lg q-px-sm" />
            <q-separator spaced />
          </q-card-section>
          <q-card-section class="text-primary">
            <div class="text-h6">Bem vindo ao Cognos!</div>
            <div class="text-caption text-black">Realize o login</div>
          </q-card-section>
...
export default {
  ...
  mounted () {
    // Focar automaticamente no campo de email para melhorar a acessibilidade
    this.$nextTick(() => {
