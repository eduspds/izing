  ...
  <div>
    <q-card bordered
      ...
      <q-card-section>
        ...
        <!-- Info sobre variáveis importadas -->
        <div v-if="$route.params.campanha.customVariables && $route.params.campanha.customVariables.length > 0"
          class="row q-mt-sm q-gutter-xs">
          <q-chip color="green" text-color="white" icon="mdi-variable">
            {{ $route.params.campanha.customVariables.length }} variáveis personalizadas
          </q-chip>
          <q-chip color="orange" text-color="white" icon="mdi-file-excel">
            Contatos importados via XLSX
          </q-chip>
        </div>
