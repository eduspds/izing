const backendErrors = {
  ...
  ERR_CONFIDENTIAL_ALREADY_ACTIVE:
    'O sigilo já está ativo neste ticket por outro usuário. Apenas o usuário que ativou o sigilo pode gerenciá-lo.',
  ERR_NO_PERMISSION_CONFIDENTIAL:
    'Você não tem permissão para usar o sigilo neste departamento.',
  ERR_CONFIDENTIAL_NOT_ACTIVE:
    'O sigilo não está ativo neste ticket.',
  ERR_NO_PERMISSION_DEACTIVATE_CONFIDENTIAL:
    'Apenas o usuário que ativou o sigilo pode desativá-lo.',
  ERR_NO_PERMISSION_SHOW_CONFIDENTIAL:
    'Apenas o usuário que ativou o sigilo pode visualizar as mensagens sigilosas.',
  ERR_TICKET_CONFIDENTIAL_IN_USE:
    'Este ticket está sendo usado por outro usuário.'
}
